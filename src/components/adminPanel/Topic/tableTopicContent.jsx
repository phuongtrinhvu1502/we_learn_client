...
const TableOpportunity = ({ listTopicContent, filterDropdownVisible, searchText, changeInputSearch, onFilterDropdownVisibleChange, onInputChange, pagination, onDelete, onRemove,
    searchInput, onRestore, changePageSize, handleDelete, handleRestore, filterParam, rowSelection, handleTableChange }) => {
    let data = listTopicContent.results;
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record) =>
                <Link to={'/system-control/post-topic-content/' + record.article_id}
        ...
        <div>
            {lstPermission.indexOf("PROPERTIES-8") > -1 &&
                <Button type="primary" size='large' className="margin-bottom-5">
                    <Link to={'/system-control/post-topic-content/'}
