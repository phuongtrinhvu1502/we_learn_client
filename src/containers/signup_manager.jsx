...
import { login, resetStoreBar, signUpManager } from '../actions/bar_action';
import SignupForm from '../components/signup_manager.jsx';
const SignUp = (props) => (
	< SignupForm { ...props } />
)
...
const mapDispatchToProps = (dispatch) => {
	return {
		...
		signUpManager: (params) => {
			dispatch(signUpManager(params))
		},
	}
}
